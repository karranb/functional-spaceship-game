...
const sprites = {
  still,
  moving: [moving1, moving2, moving3, moving4, moving5, moving6, moving7, moving8],
  explosion: [
    explosion1,
    explosion2,
    explosion3,
...
export const MOVING_AREA_FACTOR = 300

export const BULLET_SPEED = 4
export const BULLET_POWER = 300
export const SPACESHIP_SPEED = 2
